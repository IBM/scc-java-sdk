...
# IBM Cloud Security & Compliance Center Java SDK Version 0.0.31
...
--- | ---
[FindingsApi](https://cloud.ibm.com/apidocs/security-advisor/findings) | FindingsApi:0.0.31
[NotificationsApi](https://cloud.ibm.com/apidocs/security-advisor/notifications) | NotificationsApi:0.0.31
[ConfigurationGovernanceApi](https://cloud.ibm.com/apidocs/security-compliance/config) | ConfigurationGovernanceApi:0.0.31
...
### Gradle
```gradle
compile 'com.ibm.cloud:findings:0.0.31'
```
