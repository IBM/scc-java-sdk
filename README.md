...
# IBM Cloud Security & Compliance Center Java SDK Version 0.0.23
...
--- | ---
[FindingsApi](https://cloud.ibm.com/apidocs/security-advisor/findings) | FindingsApi:0.0.23
[NotificationsApi](https://cloud.ibm.com/apidocs/security-advisor/notifications) | NotificationsApi:0.0.23
[ConfigurationGovernanceApi](https://cloud.ibm.com/apidocs/security-compliance/config) | ConfigurationGovernanceApi:0.0.23
...
## Installation
The current version of this SDK is: 0.0.23
...
### Gradle
```gradle
compile 'com.ibm.cloud:findings:0.0.23'
```
