...
/**
 * Unit test class for the ListControlLibrariesOptions model.
 */
public class ListControlLibrariesOptionsTest {
  ...
  public void testListControlLibrariesOptions() throws Throwable {
    ListControlLibrariesOptions listControlLibrariesOptionsModel = new ListControlLibrariesOptions.Builder()
      ...
      .build();
    assertEquals(listControlLibrariesOptionsModel.instanceId(), "testString");
    assertEquals(listControlLibrariesOptionsModel.transactionId(), "testString");
  }
