...
/**
 * Unit test class for the AttachmentProfileRequest model.
 */
public class AttachmentProfileRequestTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAttachmentProfileRequest() throws Throwable {
    ...
    AttachmentProfileRequest attachmentProfileRequestModel = new AttachmentProfileRequest.Builder()
      .attachments(java.util.Arrays.asList(attachmentPayloadModel))
      .build();
    assertEquals(attachmentProfileRequestModel.attachments(), java.util.Arrays.asList(attachmentPayloadModel));

    String json = TestUtilities.serialize(attachmentProfileRequestModel);

    AttachmentProfileRequest attachmentProfileRequestModelNew = TestUtilities.deserialize(json, AttachmentProfileRequest.class);
    assertTrue(attachmentProfileRequestModelNew instanceof AttachmentProfileRequest);
  }
}