...
/**
 * Unit test class for the AttachmentProfileResponse model.
 */
public class AttachmentProfileResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAttachmentProfileResponse() throws Throwable {
    AttachmentProfileResponse attachmentProfileResponseModel = new AttachmentProfileResponse();
    assertNull(attachmentProfileResponseModel.getProfileId());
    assertNull(attachmentProfileResponseModel.getAttachments());
  }
}