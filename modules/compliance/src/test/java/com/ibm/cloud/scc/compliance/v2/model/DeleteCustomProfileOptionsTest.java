...
/**
 * Unit test class for the DeleteCustomProfileOptions model.
 */
public class DeleteCustomProfileOptionsTest {
  ...
  public void testDeleteCustomProfileOptions() throws Throwable {
    ...
    assertEquals(deleteCustomProfileOptionsModel.instanceId(), "testString");
    assertEquals(deleteCustomProfileOptionsModel.transactionId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteCustomProfileOptionsError() throws Throwable {
    new DeleteCustomProfileOptions.Builder().build();
  }
