...
/**
 * Unit test class for the GetControlLibraryOptions model.
 */
public class GetControlLibraryOptionsTest {
  ...
  public void testGetControlLibraryOptions() throws Throwable {
    ...
    assertEquals(getControlLibraryOptionsModel.instanceId(), "testString");
    assertEquals(getControlLibraryOptionsModel.transactionId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetControlLibraryOptionsError() throws Throwable {
    new GetControlLibraryOptions.Builder().build();
  }
