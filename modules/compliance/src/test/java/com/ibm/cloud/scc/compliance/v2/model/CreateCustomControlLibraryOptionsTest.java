...
public class CreateCustomControlLibraryOptionsTest {
  ...
  public void testCreateCustomControlLibraryOptions() throws Throwable {
    ...
    CreateCustomControlLibraryOptions createCustomControlLibraryOptionsModel = new CreateCustomControlLibraryOptions.Builder()
      ...
      .build();
    assertEquals(createCustomControlLibraryOptionsModel.instanceId(), "testString");
    assertEquals(createCustomControlLibraryOptionsModel.id(), "testString");
    assertEquals(createCustomControlLibraryOptionsModel.accountId(), "testString");
    ...
    assertEquals(createCustomControlLibraryOptionsModel.versionGroupLabel(), "testString");
    ...
    assertEquals(createCustomControlLibraryOptionsModel.controls(), java.util.Arrays.asList(controlsInControlLibRequestPayloadModel));
    assertEquals(createCustomControlLibraryOptionsModel.transactionId(), "testString");
  }
