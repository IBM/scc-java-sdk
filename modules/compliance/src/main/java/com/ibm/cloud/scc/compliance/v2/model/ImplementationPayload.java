 ...
 */
public class ImplementationPayload extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ImplementationPayload instance.
     *
     * @param implementationPayload the instance to initialize the Builder with
     */
    private Builder(ImplementationPayload implementationPayload) {
      this.assessmentId = implementationPayload.assessmentId;
      this.assessmentMethod = implementationPayload.assessmentMethod;
      this.assessmentType = implementationPayload.assessmentType;
      this.assessmentDescription = implementationPayload.assessmentDescription;
      this.parameterCount = implementationPayload.parameterCount;
      this.parameters = implementationPayload.parameters;
    }
    ...
    /**
     * Builds a ImplementationPayload.
     *
     * @return the new ImplementationPayload instance
     */
    public ImplementationPayload build() {
      return new ImplementationPayload(this);
    }
     ...
     * @return the ImplementationPayload builder
     */
  ...
  protected ImplementationPayload() { }

  protected ImplementationPayload(Builder builder) {
   ...
   * New builder.
   *
   * @return a ImplementationPayload builder
   */
