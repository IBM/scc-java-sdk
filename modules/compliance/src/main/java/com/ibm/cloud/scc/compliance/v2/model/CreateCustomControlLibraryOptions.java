...
public class CreateCustomControlLibraryOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CreateCustomControlLibraryOptions createCustomControlLibraryOptions) {
      this.instanceId = createCustomControlLibraryOptions.instanceId;
      this.id = createCustomControlLibraryOptions.id;
      this.accountId = createCustomControlLibraryOptions.accountId;
      ...
      this.transactionId = createCustomControlLibraryOptions.transactionId;
    }
