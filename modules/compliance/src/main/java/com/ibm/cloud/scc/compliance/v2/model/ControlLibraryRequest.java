 ...
 */
public class ControlLibraryRequest extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ControlLibraryRequest instance.
     *
     * @param controlLibraryRequest the instance to initialize the Builder with
     */
    private Builder(ControlLibraryRequest controlLibraryRequest) {
    ...
    /**
     * Builds a ControlLibraryRequest.
     *
     * @return the new ControlLibraryRequest instance
     */
    public ControlLibraryRequest build() {
      return new ControlLibraryRequest(this);
    }
     ...
     * @return the ControlLibraryRequest builder
     */
  ...
  protected ControlLibraryRequest() { }

  protected ControlLibraryRequest(Builder builder) {
    id = builder.id;
   ...
   * New builder.
   *
   * @return a ControlLibraryRequest builder
   */
