...
public class ListNotes {
    ...
    public static void main(String[] args) {
        ...
        ListNotesOptions opts = new ListNotesOptions.Builder().accountId(accountId).providerId(testString).build();

        Response<ApiListNotesResponse> resp = service.listNotes(opts).execute();
