...
public class CreateFindingOccurrence {
    protected CreateFindingOccurrence() {
    }
    ...
    public static void main(String[] args) {
        ...
        CreateOccurrenceOptions opts = new CreateOccurrenceOptions.Builder().accountId(accountId).providerId(testString)
                ...
                .id(testString).resourceUrl(testString).remediation(testString).finding(finding).replaceIfExists(true)
                .build();
