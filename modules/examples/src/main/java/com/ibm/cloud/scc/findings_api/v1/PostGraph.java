...
public class PostGraph {
    ...
    public static void main(String[] args) {
        ...
        PostGraphOptions opts = new PostGraphOptions.Builder().accountId(accountId).contentType("application/graphql")
                .body(new java.io.ByteArrayInputStream("{notes{id}}".getBytes())).build();

        Response<Void> resp = service.postGraph(opts).execute();
