...
public class CreateTimeSeriesCardKpi {
        protected CreateTimeSeriesCardKpi() {
        }
        ...
        public static void main(String[] args) {
                ...
                ValueTypeKpiValueType valueType = new ValueTypeKpiValueType.Builder().kind("KPI")
                                .kpiNoteName(testString).text(testString).build();

                CardElementTimeSeriesCardElement element = new CardElementTimeSeriesCardElement.Builder()
