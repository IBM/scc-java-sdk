...
/**
 * Unit test class for the ScopeCollection model.
 */
public class ScopeCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testScopeCollection() throws Throwable {
    ScopeCollection scopeCollectionModel = new ScopeCollection();
    assertNull(scopeCollectionModel.getLimit());
    assertNull(scopeCollectionModel.getTotalCount());
    assertNull(scopeCollectionModel.getFirst());
    assertNull(scopeCollectionModel.getNext());
    assertNull(scopeCollectionModel.getScopes());
  }
}