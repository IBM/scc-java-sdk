...
public class ParameterInfoTest {
  ...
  public void testParameterInfo() throws Throwable {
    ...
    assertEquals(parameterInfoModelNew.parameterName(), "location");
    assertEquals(parameterInfoModelNew.parameterDisplayName(), "Location");
    assertEquals(parameterInfoModelNew.parameterType(), "string");
    assertEquals(parameterInfoModelNew.parameterValue(), "public");
  }
}