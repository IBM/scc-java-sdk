...
/**
 * Unit test class for the EvaluationPage model.
 */
public class EvaluationPageTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testEvaluationPage() throws Throwable {
    EvaluationPage evaluationPageModel = new EvaluationPage();
    assertNull(evaluationPageModel.getTotalCount());
    assertNull(evaluationPageModel.getLimit());
    assertNull(evaluationPageModel.getStart());
    assertNull(evaluationPageModel.getFirst());
    assertNull(evaluationPageModel.getNext());
    assertNull(evaluationPageModel.getHomeAccountId());
    assertNull(evaluationPageModel.getReportId());
    assertNull(evaluationPageModel.getEvaluations());
  }
}