...
/**
 * Unit test class for the GetReportTagsOptions model.
 */
public class GetReportTagsOptionsTest {
  ...
  public void testGetReportTagsOptionsError() throws Throwable {
    new GetReportTagsOptions.Builder().build();
  }
