...
public class ScanTest {
  ...
  public void testScan() throws Throwable {
    ...
    assertNull(scanModel.getId());
    assertNull(scanModel.getAccountId());
    assertNull(scanModel.getAttachmentId());
    assertNull(scanModel.getReportId());
    assertNull(scanModel.getStatus());
    assertNull(scanModel.getLastScanTime());
    assertNull(scanModel.getNextScanTime());
    assertNull(scanModel.getScanType());
    assertNull(scanModel.getOccurence());
  }
}