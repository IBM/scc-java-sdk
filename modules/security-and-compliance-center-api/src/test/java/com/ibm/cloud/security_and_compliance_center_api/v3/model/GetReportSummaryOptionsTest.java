...
/**
 * Unit test class for the GetReportSummaryOptions model.
 */
public class GetReportSummaryOptionsTest {
  ...
  public void testGetReportSummaryOptionsError() throws Throwable {
    new GetReportSummaryOptions.Builder().build();
  }
