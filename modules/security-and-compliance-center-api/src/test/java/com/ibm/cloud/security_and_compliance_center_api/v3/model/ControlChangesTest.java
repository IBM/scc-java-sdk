...
/**
 * Unit test class for the ControlChanges model.
 */
public class ControlChangesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testControlChanges() throws Throwable {
    ControlChanges controlChangesModel = new ControlChanges();
    assertNull(controlChangesModel.getTotalAdded());
    assertNull(controlChangesModel.getTotalRemoved());
    assertNull(controlChangesModel.getTotalUpdated());
    assertNull(controlChangesModel.getAdded());
    assertNull(controlChangesModel.getRemoved());
    assertNull(controlChangesModel.getUpdated());
  }
}