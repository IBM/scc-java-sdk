...
/**
 * Unit test class for the RequiredConfigConditionSubRuleConditionSubRuleConditionAllIf model.
 */
public class RequiredConfigConditionSubRuleConditionSubRuleConditionAllIfTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRequiredConfigConditionSubRuleConditionSubRuleConditionAllIf() throws Throwable {
    ...
    RequiredConfigConditionSubRuleConditionSubRuleConditionAllIf requiredConfigConditionSubRuleConditionSubRuleConditionAllIfModel = new RequiredConfigConditionSubRuleConditionSubRuleConditionAllIf.Builder()
      .allIfexists(subRuleModel)
      .build();
    assertEquals(requiredConfigConditionSubRuleConditionSubRuleConditionAllIfModel.allIfexists(), subRuleModel);

    String json = TestUtilities.serialize(requiredConfigConditionSubRuleConditionSubRuleConditionAllIfModel);

    RequiredConfigConditionSubRuleConditionSubRuleConditionAllIf requiredConfigConditionSubRuleConditionSubRuleConditionAllIfModelNew = TestUtilities.deserialize(json, RequiredConfigConditionSubRuleConditionSubRuleConditionAllIf.class);
    assertTrue(requiredConfigConditionSubRuleConditionSubRuleConditionAllIfModelNew instanceof RequiredConfigConditionSubRuleConditionSubRuleConditionAllIf);
    assertEquals(requiredConfigConditionSubRuleConditionSubRuleConditionAllIfModelNew.allIfexists().toString(), subRuleModel.toString());
  }
}