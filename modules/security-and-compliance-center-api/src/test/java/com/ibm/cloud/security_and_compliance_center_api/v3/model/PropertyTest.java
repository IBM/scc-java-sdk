...
public class PropertyTest {
  ...
  public void testProperty() throws Throwable {
    ...
    assertNull(propertyModel.getPropertyDescription());
    assertNull(propertyModel.getOperator());
    assertNull(propertyModel.getExpectedValue());
    assertNull(propertyModel.getFoundValue());
  }
}