...
/**
 * Unit test class for the RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf model.
 */
public class RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIfTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf() throws Throwable {
    ...
    RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf requiredConfigConditionSubRuleConditionSubRuleConditionAnyIfModel = new RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf.Builder()
      .anyIfexists(subRuleModel)
      .build();
    assertEquals(requiredConfigConditionSubRuleConditionSubRuleConditionAnyIfModel.anyIfexists(), subRuleModel);

    String json = TestUtilities.serialize(requiredConfigConditionSubRuleConditionSubRuleConditionAnyIfModel);

    RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf requiredConfigConditionSubRuleConditionSubRuleConditionAnyIfModelNew = TestUtilities.deserialize(json, RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf.class);
    assertTrue(requiredConfigConditionSubRuleConditionSubRuleConditionAnyIfModelNew instanceof RequiredConfigConditionSubRuleConditionSubRuleConditionAnyIf);
    assertEquals(requiredConfigConditionSubRuleConditionSubRuleConditionAnyIfModelNew.anyIfexists().toString(), subRuleModel.toString());
  }
}