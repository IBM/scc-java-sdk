...
/**
 * Unit test class for the ControlChangesUpdated model.
 */
public class ControlChangesUpdatedTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testControlChangesUpdated() throws Throwable {
    ControlChangesUpdated controlChangesUpdatedModel = new ControlChangesUpdated();
    assertNull(controlChangesUpdatedModel.getCurrent());
    assertNull(controlChangesUpdatedModel.getLatest());
  }
}