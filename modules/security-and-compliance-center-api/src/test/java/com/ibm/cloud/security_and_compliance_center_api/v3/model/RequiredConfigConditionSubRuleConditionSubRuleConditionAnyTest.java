...
/**
 * Unit test class for the RequiredConfigConditionSubRuleConditionSubRuleConditionAny model.
 */
public class RequiredConfigConditionSubRuleConditionSubRuleConditionAnyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRequiredConfigConditionSubRuleConditionSubRuleConditionAny() throws Throwable {
    ...
    RequiredConfigConditionSubRuleConditionSubRuleConditionAny requiredConfigConditionSubRuleConditionSubRuleConditionAnyModel = new RequiredConfigConditionSubRuleConditionSubRuleConditionAny.Builder()
      .any(subRuleModel)
      .build();
    assertEquals(requiredConfigConditionSubRuleConditionSubRuleConditionAnyModel.any(), subRuleModel);

    String json = TestUtilities.serialize(requiredConfigConditionSubRuleConditionSubRuleConditionAnyModel);

    RequiredConfigConditionSubRuleConditionSubRuleConditionAny requiredConfigConditionSubRuleConditionSubRuleConditionAnyModelNew = TestUtilities.deserialize(json, RequiredConfigConditionSubRuleConditionSubRuleConditionAny.class);
    assertTrue(requiredConfigConditionSubRuleConditionSubRuleConditionAnyModelNew instanceof RequiredConfigConditionSubRuleConditionSubRuleConditionAny);
    assertEquals(requiredConfigConditionSubRuleConditionSubRuleConditionAnyModelNew.any().toString(), subRuleModel.toString());
  }
}