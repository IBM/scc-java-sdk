...
public class ScopeTest {
  ...
  public void testScope() throws Throwable {
    ...
    assertNull(scopeModel.getId());
    assertNull(scopeModel.getName());
    assertNull(scopeModel.getDescription());
    assertNull(scopeModel.getEnvironment());
    assertNull(scopeModel.getXProperties());
    assertNull(scopeModel.getAccountId());
    assertNull(scopeModel.getInstanceId());
    assertNull(scopeModel.getCreatedBy());
    assertNull(scopeModel.getCreatedOn());
    assertNull(scopeModel.getUpdatedBy());
    assertNull(scopeModel.getUpdatedOn());
    assertNull(scopeModel.getAttachmentCount());
  }
}