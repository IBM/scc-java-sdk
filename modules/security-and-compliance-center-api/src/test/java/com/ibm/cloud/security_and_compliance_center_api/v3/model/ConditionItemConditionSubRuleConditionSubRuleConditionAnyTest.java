...
/**
 * Unit test class for the ConditionItemConditionSubRuleConditionSubRuleConditionAny model.
 */
public class ConditionItemConditionSubRuleConditionSubRuleConditionAnyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConditionItemConditionSubRuleConditionSubRuleConditionAny() throws Throwable {
    ...
    ConditionItemConditionSubRuleConditionSubRuleConditionAny conditionItemConditionSubRuleConditionSubRuleConditionAnyModel = new ConditionItemConditionSubRuleConditionSubRuleConditionAny.Builder()
      .any(subRuleModel)
      .build();
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAnyModel.any(), subRuleModel);

    String json = TestUtilities.serialize(conditionItemConditionSubRuleConditionSubRuleConditionAnyModel);

    ConditionItemConditionSubRuleConditionSubRuleConditionAny conditionItemConditionSubRuleConditionSubRuleConditionAnyModelNew = TestUtilities.deserialize(json, ConditionItemConditionSubRuleConditionSubRuleConditionAny.class);
    assertTrue(conditionItemConditionSubRuleConditionSubRuleConditionAnyModelNew instanceof ConditionItemConditionSubRuleConditionSubRuleConditionAny);
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAnyModelNew.any().toString(), subRuleModel.toString());
  }
}