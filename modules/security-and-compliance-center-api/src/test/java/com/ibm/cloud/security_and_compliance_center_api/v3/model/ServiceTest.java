...
/**
 * Unit test class for the Service model.
 */
public class ServiceTest {
  ...
  public void testService() throws Throwable {
    ...
    assertNull(serviceModel.getCreatedOn());
    assertNull(serviceModel.getCreatedBy());
    assertNull(serviceModel.getUpdatedOn());
    assertNull(serviceModel.getUpdatedBy());
    assertNull(serviceModel.getServiceName());
    assertNull(serviceModel.getServiceDisplayName());
    assertNull(serviceModel.getDescription());
    assertNull(serviceModel.isMonitoringEnabled());
    assertNull(serviceModel.isEnforcementEnabled());
    assertNull(serviceModel.isServiceListingEnabled());
    assertNull(serviceModel.getConfigInformationPoint());
    assertNull(serviceModel.getSupportedConfigs());
  }
}