...
/**
 * Unit test class for the RuleTarget model.
 */
public class RuleTargetTest {
  ...
  @Test
  public void testRuleTarget() throws Throwable {
    ...
    String json = TestUtilities.serialize(ruleTargetModel);

    RuleTarget ruleTargetModelNew = TestUtilities.deserialize(json, RuleTarget.class);
    assertTrue(ruleTargetModelNew instanceof RuleTarget);
    assertEquals(ruleTargetModelNew.serviceName(), "testString");
    assertEquals(ruleTargetModelNew.serviceDisplayName(), "testString");
    assertEquals(ruleTargetModelNew.resourceKind(), "testString");
    assertEquals(ruleTargetModelNew.ref(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRuleTargetError() throws Throwable {
    new RuleTarget.Builder().build();
  }
