...
/**
 * Unit test class for the SubScopeResponse model.
 */
public class SubScopeResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSubScopeResponse() throws Throwable {
    SubScopeResponse subScopeResponseModel = new SubScopeResponse();
    assertNull(subScopeResponseModel.getSubscopes());
  }
}