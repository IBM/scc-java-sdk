...
/**
 * Unit test class for the ConditionItemConditionSubRuleConditionSubRuleConditionAllIf model.
 */
public class ConditionItemConditionSubRuleConditionSubRuleConditionAllIfTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConditionItemConditionSubRuleConditionSubRuleConditionAllIf() throws Throwable {
    ...
    ConditionItemConditionSubRuleConditionSubRuleConditionAllIf conditionItemConditionSubRuleConditionSubRuleConditionAllIfModel = new ConditionItemConditionSubRuleConditionSubRuleConditionAllIf.Builder()
      .allIfexists(subRuleModel)
      .build();
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAllIfModel.allIfexists(), subRuleModel);

    String json = TestUtilities.serialize(conditionItemConditionSubRuleConditionSubRuleConditionAllIfModel);

    ConditionItemConditionSubRuleConditionSubRuleConditionAllIf conditionItemConditionSubRuleConditionSubRuleConditionAllIfModelNew = TestUtilities.deserialize(json, ConditionItemConditionSubRuleConditionSubRuleConditionAllIf.class);
    assertTrue(conditionItemConditionSubRuleConditionSubRuleConditionAllIfModelNew instanceof ConditionItemConditionSubRuleConditionSubRuleConditionAllIf);
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAllIfModelNew.allIfexists().toString(), subRuleModel.toString());
  }
}