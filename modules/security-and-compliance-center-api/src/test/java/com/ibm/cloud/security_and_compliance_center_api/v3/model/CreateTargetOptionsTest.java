...
/**
 * Unit test class for the CreateTargetOptions model.
 */
public class CreateTargetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateTargetOptions() throws Throwable {
    ...
    CreateTargetOptions createTargetOptionsModel = new CreateTargetOptions.Builder()
      ...
      .build();
    assertEquals(createTargetOptionsModel.instanceId(), "acd7032c-15a3-484f-bf5b-67d41534d940");
    assertEquals(createTargetOptionsModel.accountId(), "be200c80cabc456e91139e4152327823");
    assertEquals(createTargetOptionsModel.trustedProfileId(), "Profile-a0a4c149-4fed-47ff-bfb2-680bcfaa64d3");
    assertEquals(createTargetOptionsModel.name(), "Sample Target Name");
    assertEquals(createTargetOptionsModel.credentials(), java.util.Arrays.asList(credentialModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateTargetOptionsError() throws Throwable {
    new CreateTargetOptions.Builder().build();
  }
