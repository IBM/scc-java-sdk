...
/**
 * Unit test class for the Credential model.
 */
public class CredentialTest {
  ...
  @Test
  public void testCredential() throws Throwable {
    ...
    Credential credentialModel = new Credential.Builder()
      ...
      .build();
    assertEquals(credentialModel.secretCrn(), "testString");
    assertEquals(credentialModel.resources(), java.util.Arrays.asList(resourceModel));

    String json = TestUtilities.serialize(credentialModel);

    Credential credentialModelNew = TestUtilities.deserialize(json, Credential.class);
    assertTrue(credentialModelNew instanceof Credential);
    assertEquals(credentialModelNew.secretCrn(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCredentialError() throws Throwable {
    new Credential.Builder().build();
  }
