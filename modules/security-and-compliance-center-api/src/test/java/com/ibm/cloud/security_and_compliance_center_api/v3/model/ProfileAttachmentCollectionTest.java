...
/**
 * Unit test class for the ProfileAttachmentCollection model.
 */
public class ProfileAttachmentCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProfileAttachmentCollection() throws Throwable {
    ProfileAttachmentCollection profileAttachmentCollectionModel = new ProfileAttachmentCollection();
    assertNull(profileAttachmentCollectionModel.getLimit());
    assertNull(profileAttachmentCollectionModel.getTotalCount());
    assertNull(profileAttachmentCollectionModel.getFirst());
    assertNull(profileAttachmentCollectionModel.getNext());
    assertNull(profileAttachmentCollectionModel.getAttachments());
  }
}