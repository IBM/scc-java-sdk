...
/**
 * Unit test class for the ConditionItemConditionSubRuleConditionSubRuleConditionAll model.
 */
public class ConditionItemConditionSubRuleConditionSubRuleConditionAllTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConditionItemConditionSubRuleConditionSubRuleConditionAll() throws Throwable {
    ...
    ConditionItemConditionSubRuleConditionSubRuleConditionAll conditionItemConditionSubRuleConditionSubRuleConditionAllModel = new ConditionItemConditionSubRuleConditionSubRuleConditionAll.Builder()
      .all(subRuleModel)
      .build();
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAllModel.all(), subRuleModel);

    String json = TestUtilities.serialize(conditionItemConditionSubRuleConditionSubRuleConditionAllModel);

    ConditionItemConditionSubRuleConditionSubRuleConditionAll conditionItemConditionSubRuleConditionSubRuleConditionAllModelNew = TestUtilities.deserialize(json, ConditionItemConditionSubRuleConditionSubRuleConditionAll.class);
    assertTrue(conditionItemConditionSubRuleConditionSubRuleConditionAllModelNew instanceof ConditionItemConditionSubRuleConditionSubRuleConditionAll);
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAllModelNew.all().toString(), subRuleModel.toString());
  }
}