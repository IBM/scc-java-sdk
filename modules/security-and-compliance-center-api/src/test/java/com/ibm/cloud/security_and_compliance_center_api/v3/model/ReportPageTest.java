...
/**
 * Unit test class for the ReportPage model.
 */
public class ReportPageTest {
  ...
  @Test
  public void testReportPage() throws Throwable {
    ReportPage reportPageModel = new ReportPage();
    assertNull(reportPageModel.getTotalCount());
    assertNull(reportPageModel.getLimit());
    assertNull(reportPageModel.getStart());
    assertNull(reportPageModel.getFirst());
    assertNull(reportPageModel.getNext());
    assertNull(reportPageModel.getHomeAccountId());
    assertNull(reportPageModel.getReports());
  }
}