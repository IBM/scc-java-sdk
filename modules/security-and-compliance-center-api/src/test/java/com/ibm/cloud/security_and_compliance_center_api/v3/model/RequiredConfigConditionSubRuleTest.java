...
/**
 * Unit test class for the RequiredConfigConditionSubRule model.
 */
public class RequiredConfigConditionSubRuleTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testRequiredConfigConditionSubRule() throws Throwable {
    RequiredConfigConditionSubRule requiredConfigConditionSubRuleModel = new RequiredConfigConditionSubRule();
    assertNotNull(requiredConfigConditionSubRuleModel);
  }
}