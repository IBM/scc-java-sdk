...
/**
 * Unit test class for the ConditionItemConditionSubRule model.
 */
public class ConditionItemConditionSubRuleTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testConditionItemConditionSubRule() throws Throwable {
    ConditionItemConditionSubRule conditionItemConditionSubRuleModel = new ConditionItemConditionSubRule();
    assertNotNull(conditionItemConditionSubRuleModel);
  }
}