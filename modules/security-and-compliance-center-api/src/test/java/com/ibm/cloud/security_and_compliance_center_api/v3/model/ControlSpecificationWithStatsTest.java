...
/**
 * Unit test class for the ControlSpecificationWithStats model.
 */
public class ControlSpecificationWithStatsTest {
  ...
  public void testControlSpecificationWithStats() throws Throwable {
    ...
    assertNull(controlSpecificationWithStatsModel.getStatus());
    assertNull(controlSpecificationWithStatsModel.getTotalCount());
    assertNull(controlSpecificationWithStatsModel.getCompliantCount());
