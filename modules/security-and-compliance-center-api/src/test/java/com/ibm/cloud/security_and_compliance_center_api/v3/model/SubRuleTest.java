...
/**
 * Unit test class for the SubRule model.
 */
public class SubRuleTest {
  ...
  @Test
  public void testSubRule() throws Throwable {
    ...
    String json = TestUtilities.serialize(subRuleModel);

    SubRule subRuleModelNew = TestUtilities.deserialize(json, SubRule.class);
    assertTrue(subRuleModelNew instanceof SubRule);
    assertEquals(subRuleModelNew.target().toString(), ruleTargetModel.toString());
  }
}