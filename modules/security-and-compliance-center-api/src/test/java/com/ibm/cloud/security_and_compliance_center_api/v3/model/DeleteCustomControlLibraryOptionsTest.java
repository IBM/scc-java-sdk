...
public class DeleteCustomControlLibraryOptionsTest {
  ...
  public void testDeleteCustomControlLibraryOptions() throws Throwable {
    DeleteCustomControlLibraryOptions deleteCustomControlLibraryOptionsModel = new DeleteCustomControlLibraryOptions.Builder()
      ...
      .build();
    assertEquals(deleteCustomControlLibraryOptionsModel.instanceId(), "acd7032c-15a3-484f-bf5b-67d41534d940");
    assertEquals(deleteCustomControlLibraryOptionsModel.controlLibraryId(), "testString");
    assertEquals(deleteCustomControlLibraryOptionsModel.accountId(), "testString");
  }
