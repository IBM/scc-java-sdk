...
/**
 * Unit test class for the ConditionItemConditionSubRuleConditionSubRuleConditionAnyIf model.
 */
public class ConditionItemConditionSubRuleConditionSubRuleConditionAnyIfTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConditionItemConditionSubRuleConditionSubRuleConditionAnyIf() throws Throwable {
    ...
    ConditionItemConditionSubRuleConditionSubRuleConditionAnyIf conditionItemConditionSubRuleConditionSubRuleConditionAnyIfModel = new ConditionItemConditionSubRuleConditionSubRuleConditionAnyIf.Builder()
      .anyIfexists(subRuleModel)
      .build();
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAnyIfModel.anyIfexists(), subRuleModel);

    String json = TestUtilities.serialize(conditionItemConditionSubRuleConditionSubRuleConditionAnyIfModel);

    ConditionItemConditionSubRuleConditionSubRuleConditionAnyIf conditionItemConditionSubRuleConditionSubRuleConditionAnyIfModelNew = TestUtilities.deserialize(json, ConditionItemConditionSubRuleConditionSubRuleConditionAnyIf.class);
    assertTrue(conditionItemConditionSubRuleConditionSubRuleConditionAnyIfModelNew instanceof ConditionItemConditionSubRuleConditionSubRuleConditionAnyIf);
    assertEquals(conditionItemConditionSubRuleConditionSubRuleConditionAnyIfModelNew.anyIfexists().toString(), subRuleModel.toString());
  }
}