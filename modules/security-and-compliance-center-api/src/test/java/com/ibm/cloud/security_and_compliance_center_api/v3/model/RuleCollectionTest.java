...
/**
 * Unit test class for the RuleCollection model.
 */
public class RuleCollectionTest {
  ...
  @Test
  public void testRuleCollection() throws Throwable {
    RuleCollection ruleCollectionModel = new RuleCollection();
    assertNull(ruleCollectionModel.getLimit());
    assertNull(ruleCollectionModel.getTotalCount());
    assertNull(ruleCollectionModel.getFirst());
    assertNull(ruleCollectionModel.getNext());
    assertNull(ruleCollectionModel.getRules());
  }
}