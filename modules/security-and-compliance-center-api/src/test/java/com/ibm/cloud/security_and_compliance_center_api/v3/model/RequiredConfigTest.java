...
/**
 * Unit test class for the RequiredConfig model.
 */
public class RequiredConfigTest {
  ...
  @Test
  public void testRequiredConfig() throws Throwable {
    RequiredConfig requiredConfigModel = new RequiredConfig();
    assertNotNull(requiredConfigModel);
  }
}