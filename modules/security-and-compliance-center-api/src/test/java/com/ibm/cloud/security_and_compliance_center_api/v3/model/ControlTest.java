...
public class ControlTest {
  ...
  public void testControl() throws Throwable {
    Control controlModel = new Control();
    assertNull(controlModel.getControlName());
    assertNull(controlModel.getControlId());
    assertNull(controlModel.getControlDescription());
    assertNull(controlModel.getControlCategory());
    assertNull(controlModel.getControlParent());
    assertNull(controlModel.getControlSeverity());
    assertNull(controlModel.getControlTags());
    assertNull(controlModel.getControlSpecifications());
    assertNull(controlModel.getControlDocs());
    assertNull(controlModel.getStatus());
  }
}