...
/**
 * Unit test class for the ProfileAttachmentResponse model.
 */
public class ProfileAttachmentResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProfileAttachmentResponse() throws Throwable {
    ProfileAttachmentResponse profileAttachmentResponseModel = new ProfileAttachmentResponse();
    assertNull(profileAttachmentResponseModel.getProfileId());
    assertNull(profileAttachmentResponseModel.getAttachments());
  }
}