...
/**
 * Unit test class for the ComparePredefinedProfilesResponse model.
 */
public class ComparePredefinedProfilesResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testComparePredefinedProfilesResponse() throws Throwable {
    ComparePredefinedProfilesResponse comparePredefinedProfilesResponseModel = new ComparePredefinedProfilesResponse();
    assertNull(comparePredefinedProfilesResponseModel.getCurrentPredefinedVersion());
    assertNull(comparePredefinedProfilesResponseModel.getLatestPredefinedVersion());
    assertNull(comparePredefinedProfilesResponseModel.getControlsChanges());
    assertNull(comparePredefinedProfilesResponseModel.getDefaultParametersChanges());
  }
}