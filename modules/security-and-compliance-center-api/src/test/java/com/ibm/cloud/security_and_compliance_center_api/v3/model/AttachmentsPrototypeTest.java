...
/**
 * Unit test class for the AttachmentsPrototype model.
 */
public class AttachmentsPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAttachmentsPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(attachmentsPrototypeModel);

    AttachmentsPrototype attachmentsPrototypeModelNew = TestUtilities.deserialize(json, AttachmentsPrototype.class);
    assertTrue(attachmentsPrototypeModelNew instanceof AttachmentsPrototype);
    assertEquals(attachmentsPrototypeModelNew.id(), "130003ea8bfa43c5aacea07a86da3000");
    assertEquals(attachmentsPrototypeModelNew.name(), "account-130003ea8bfa43c5aacea07a86da3000");
    assertEquals(attachmentsPrototypeModelNew.description(), "Test description");
    assertEquals(attachmentsPrototypeModelNew.status(), "enabled");
    assertEquals(attachmentsPrototypeModelNew.schedule(), "daily");
    assertEquals(attachmentsPrototypeModelNew.notifications().toString(), attachmentsNotificationsPrototypeModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAttachmentsPrototypeError() throws Throwable {
    new AttachmentsPrototype.Builder().build();
  }
