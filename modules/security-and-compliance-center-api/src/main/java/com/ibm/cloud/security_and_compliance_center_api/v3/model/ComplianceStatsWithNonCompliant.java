 ...
 */
public class ComplianceStatsWithNonCompliant extends GenericModel {
  ...
  @SerializedName("not_compliant_controls")
  protected List<ControlSummary> notCompliantControls;

  protected ComplianceStatsWithNonCompliant() { }
  ...
  /**
   * Gets the notCompliantControls.
   *
   * The list of non compliant controls.
   *
   * @return the notCompliantControls
   */
  public List<ControlSummary> getNotCompliantControls() {
    return notCompliantControls;
  }
}
