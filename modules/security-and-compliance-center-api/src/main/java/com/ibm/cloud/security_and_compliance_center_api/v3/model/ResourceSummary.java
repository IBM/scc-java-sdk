 ...
 */
public class ResourceSummary extends GenericModel {
  ...
  @SerializedName("top_failed")
  protected List<ResourceSummaryItem> topFailed;
   ...
   *
   * @return the topFailed
   */
  public List<ResourceSummaryItem> getTopFailed() {
    return topFailed;
  }
}
