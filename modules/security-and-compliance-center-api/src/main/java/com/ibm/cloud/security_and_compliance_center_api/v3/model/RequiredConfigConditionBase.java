 ...
 */
public class RequiredConfigConditionBase extends RequiredConfig {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RequiredConfigConditionBase instance.
     *
     * @param requiredConfigConditionBase the instance to initialize the Builder with
     */
    public Builder(RequiredConfig requiredConfigConditionBase) {
      this.description = requiredConfigConditionBase.description;
      this.property = requiredConfigConditionBase.property;
      this.operator = requiredConfigConditionBase.operator;
      this.value = requiredConfigConditionBase.value;
    }
    ...
    /**
     * Builds a RequiredConfigConditionBase.
     *
     * @return the new RequiredConfigConditionBase instance
     */
    public RequiredConfigConditionBase build() {
      return new RequiredConfigConditionBase(this);
    }
     ...
     * @return the RequiredConfigConditionBase builder
     */
  ...
  protected RequiredConfigConditionBase() { }

  protected RequiredConfigConditionBase(Builder builder) {
   ...
   * New builder.
   *
   * @return a RequiredConfigConditionBase builder
   */
