 ...
 */
public class RequiredConfigItemsRequiredConfigBase extends RequiredConfigItems {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RequiredConfigItemsRequiredConfigBase instance.
     *
     * @param requiredConfigItemsRequiredConfigBase the instance to initialize the Builder with
     */
    public Builder(RequiredConfigItems requiredConfigItemsRequiredConfigBase) {
      this.description = requiredConfigItemsRequiredConfigBase.description;
      this.property = requiredConfigItemsRequiredConfigBase.property;
      this.operator = requiredConfigItemsRequiredConfigBase.operator;
      this.value = requiredConfigItemsRequiredConfigBase.value;
    }
    ...
    /**
     * Builds a RequiredConfigItemsRequiredConfigBase.
     *
     * @return the new RequiredConfigItemsRequiredConfigBase instance
     */
    public RequiredConfigItemsRequiredConfigBase build() {
      return new RequiredConfigItemsRequiredConfigBase(this);
    }
     ...
     * @return the RequiredConfigItemsRequiredConfigBase builder
     */
  ...
  protected RequiredConfigItemsRequiredConfigBase() { }

  protected RequiredConfigItemsRequiredConfigBase(Builder builder) {
   ...
   * New builder.
   *
   * @return a RequiredConfigItemsRequiredConfigBase builder
   */
