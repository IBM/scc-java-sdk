...
public class ControlLibrariesPager {
   ...
   * @return a List&lt;ControlLibrary&gt; that contains the next page of results
   */
  public List<ControlLibrary> getNext() {
    if (!hasNext()) {
   ...
   * @return a List&lt;ControlLibrary&gt; containing all results returned by the "listControlLibraries" method
   */
  public List<ControlLibrary> getAll() {
    List<ControlLibrary> results = new ArrayList<>();
    while (hasNext()) {
      List<ControlLibrary> nextPage = getNext();
