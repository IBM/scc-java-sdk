 ...
 */
public class RequiredConfigRequiredConfigBase extends RequiredConfig {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RequiredConfigRequiredConfigBase instance.
     *
     * @param requiredConfigRequiredConfigBase the instance to initialize the Builder with
     */
    public Builder(RequiredConfig requiredConfigRequiredConfigBase) {
      this.description = requiredConfigRequiredConfigBase.description;
      this.property = requiredConfigRequiredConfigBase.property;
      this.operator = requiredConfigRequiredConfigBase.operator;
      this.value = requiredConfigRequiredConfigBase.value;
    }
    ...
    /**
     * Builds a RequiredConfigRequiredConfigBase.
     *
     * @return the new RequiredConfigRequiredConfigBase instance
     */
    public RequiredConfigRequiredConfigBase build() {
      return new RequiredConfigRequiredConfigBase(this);
    }
     ...
     * @return the RequiredConfigRequiredConfigBase builder
     */
  ...
  protected RequiredConfigRequiredConfigBase() { }

  protected RequiredConfigRequiredConfigBase(Builder builder) {
   ...
   * New builder.
   *
   * @return a RequiredConfigRequiredConfigBase builder
   */
