 ...
 */
public class RuleRequiredConfig extends GenericModel {
  ...
  protected List<RuleCondition> or;
  protected List<RuleCondition> and;

  protected RuleRequiredConfig() {
  }
