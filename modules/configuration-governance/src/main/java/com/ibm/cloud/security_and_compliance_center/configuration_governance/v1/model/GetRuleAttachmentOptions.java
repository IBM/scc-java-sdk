...
/**
 * The getRuleAttachment options.
 */
public class GetRuleAttachmentOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetRuleAttachmentOptions getRuleAttachmentOptions) {
      this.ruleId = getRuleAttachmentOptions.ruleId;
      this.attachmentId = getRuleAttachmentOptions.attachmentId;
      this.transactionId = getRuleAttachmentOptions.transactionId;
    }
    ...
    /**
     * Builds a GetRuleAttachmentOptions.
     *
     * @return the new GetRuleAttachmentOptions instance
     */
    public GetRuleAttachmentOptions build() {
      return new GetRuleAttachmentOptions(this);
    }
     ...
     *
     * @param ruleId the ruleId
     * @return the GetRuleAttachmentOptions builder
     */
  ...
  protected GetRuleAttachmentOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetRuleAttachmentOptions builder
   */
