...
public class TargetResource extends GenericModel {
  ...
  protected List<TargetResourceAdditionalTargetAttributesItem> additionalTargetAttributes;
  ...
  public static class Builder {
    ...
    private List<TargetResourceAdditionalTargetAttributesItem> additionalTargetAttributes;
     ...
     */
    public Builder addAdditionalTargetAttribute(TargetResourceAdditionalTargetAttributesItem additionalTargetAttribute) {
      ...
      if (this.additionalTargetAttributes == null) {
        this.additionalTargetAttributes = new ArrayList<TargetResourceAdditionalTargetAttributesItem>();
      }
     ...
     * @return the TargetResource builder
     */
    public Builder additionalTargetAttributes(List<TargetResourceAdditionalTargetAttributesItem> additionalTargetAttributes) {
   ...
   */
  public List<TargetResourceAdditionalTargetAttributesItem> additionalTargetAttributes() {
