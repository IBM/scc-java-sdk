 ...
 */
public class RuleAttachmentRequest extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(RuleAttachmentRequest ruleAttachmentRequest) {
      this.accountId = ruleAttachmentRequest.accountId;
      this.includedScope = ruleAttachmentRequest.includedScope;
      this.excludedScopes = ruleAttachmentRequest.excludedScopes;
    }
    ...
    /**
     * Builds a RuleAttachmentRequest.
     *
     * @return the new RuleAttachmentRequest instance
     */
    public RuleAttachmentRequest build() {
      return new RuleAttachmentRequest(this);
    }
     ...
     * @return the RuleAttachmentRequest builder
     */
  ...
  protected RuleAttachmentRequest(Builder builder) {
   ...
   * New builder.
   *
   * @return a RuleAttachmentRequest builder
   */
