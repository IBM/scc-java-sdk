...
/**
 * The listRuleAttachments options.
 */
public class ListRuleAttachmentsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListRuleAttachmentsOptions listRuleAttachmentsOptions) {
      this.ruleId = listRuleAttachmentsOptions.ruleId;
      this.transactionId = listRuleAttachmentsOptions.transactionId;
      this.limit = listRuleAttachmentsOptions.limit;
      this.offset = listRuleAttachmentsOptions.offset;
    }
    ...
    /**
     * Builds a ListRuleAttachmentsOptions.
     *
     * @return the new ListRuleAttachmentsOptions instance
     */
    public ListRuleAttachmentsOptions build() {
      return new ListRuleAttachmentsOptions(this);
    }
     ...
     *
     * @param ruleId the ruleId
     * @return the ListRuleAttachmentsOptions builder
     */
  ...
  protected ListRuleAttachmentsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListRuleAttachmentsOptions builder
   */
