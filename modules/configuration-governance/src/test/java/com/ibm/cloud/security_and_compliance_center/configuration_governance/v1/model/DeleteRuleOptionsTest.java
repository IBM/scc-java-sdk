...
/**
 * Unit test class for the DeleteRuleOptions model.
 */
public class DeleteRuleOptionsTest {
  ...
  public void testDeleteRuleOptionsError() throws Throwable {
    new DeleteRuleOptions.Builder().build();
  }
