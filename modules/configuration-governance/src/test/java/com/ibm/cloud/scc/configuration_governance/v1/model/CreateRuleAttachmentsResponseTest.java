...
/**
 * Unit test class for the CreateRuleAttachmentsResponse model.
 */
public class CreateRuleAttachmentsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateRuleAttachmentsResponse() throws Throwable {
    CreateRuleAttachmentsResponse createRuleAttachmentsResponseModel = new CreateRuleAttachmentsResponse();
    assertNull(createRuleAttachmentsResponseModel.getAttachments());
  }
}