...
/**
 * Unit test class for the CreateRuleAttachmentsOptions model.
 */
public class CreateRuleAttachmentsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateRuleAttachmentsOptions() throws Throwable {
    ...
    CreateRuleAttachmentsOptions createRuleAttachmentsOptionsModel = new CreateRuleAttachmentsOptions.Builder()
      ...
      .build();
    assertEquals(createRuleAttachmentsOptionsModel.ruleId(), "testString");
    assertEquals(createRuleAttachmentsOptionsModel.attachments(), new java.util.ArrayList<RuleAttachmentRequest>(java.util.Arrays.asList(ruleAttachmentRequestModel)));
    assertEquals(createRuleAttachmentsOptionsModel.transactionId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateRuleAttachmentsOptionsError() throws Throwable {
    new CreateRuleAttachmentsOptions.Builder().build();
  }
