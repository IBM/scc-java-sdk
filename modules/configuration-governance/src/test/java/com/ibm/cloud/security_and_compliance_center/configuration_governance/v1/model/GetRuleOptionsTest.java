...
/**
 * Unit test class for the GetRuleOptions model.
 */
public class GetRuleOptionsTest {
  ...
  public void testGetRuleOptionsError() throws Throwable {
    new GetRuleOptions.Builder().build();
  }
