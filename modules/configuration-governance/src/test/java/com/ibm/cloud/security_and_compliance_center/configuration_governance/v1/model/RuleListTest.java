...
public class RuleListTest {
  ...
  public void testRuleList() throws Throwable {
    ...
    assertNull(ruleListModel.getOffset());
    assertNull(ruleListModel.getLimit());
    assertNull(ruleListModel.getTotalCount());
    assertNull(ruleListModel.getFirst());
    assertNull(ruleListModel.getLast());
