...
/**
 * Unit test class for the CreateRulesResponse model.
 */
public class CreateRulesResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateRulesResponse() throws Throwable {
    CreateRulesResponse createRulesResponseModel = new CreateRulesResponse();
    assertNull(createRulesResponseModel.getRules());
  }
}