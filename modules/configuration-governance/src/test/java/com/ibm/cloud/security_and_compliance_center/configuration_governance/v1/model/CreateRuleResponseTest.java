...
/**
 * Unit test class for the CreateRuleResponse model.
 */
public class CreateRuleResponseTest {
  ...
  @Test
  public void testCreateRuleResponse() throws Throwable {
    CreateRuleResponse createRuleResponseModel = new CreateRuleResponse();
    assertNull(createRuleResponseModel.getRequestId());
    assertNull(createRuleResponseModel.getStatusCode());
    assertNull(createRuleResponseModel.getRule());
    assertNull(createRuleResponseModel.getErrors());
    assertNull(createRuleResponseModel.getTrace());
  }
}