...
/**
 * Unit test class for the GetSupportedInsightsV2Options model.
 */
public class GetSupportedInsightsV2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSupportedInsightsV2Options() throws Throwable {
    GetSupportedInsightsV2Options getSupportedInsightsV2OptionsModel = new GetSupportedInsightsV2Options.Builder()
      .transactionId("testString")
      .build();
    assertEquals(getSupportedInsightsV2OptionsModel.transactionId(), "testString");
  }
}