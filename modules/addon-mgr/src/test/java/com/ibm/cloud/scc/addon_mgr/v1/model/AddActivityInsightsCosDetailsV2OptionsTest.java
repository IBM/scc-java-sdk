...
/**
 * Unit test class for the AddActivityInsightsCosDetailsV2Options model.
 */
public class AddActivityInsightsCosDetailsV2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAddActivityInsightsCosDetailsV2Options() throws Throwable {
    ...
    AddActivityInsightsCosDetailsV2Options addActivityInsightsCosDetailsV2OptionsModel = new AddActivityInsightsCosDetailsV2Options.Builder()
      ...
      .build();
    assertEquals(addActivityInsightsCosDetailsV2OptionsModel.regionId(), "testString");
    assertEquals(addActivityInsightsCosDetailsV2OptionsModel.cosDetails(), new java.util.ArrayList<CosDetailsV2CosDetailsItem>(java.util.Arrays.asList(cosDetailsV2CosDetailsItemModel)));
    assertEquals(addActivityInsightsCosDetailsV2OptionsModel.transactionId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAddActivityInsightsCosDetailsV2OptionsError() throws Throwable {
    new AddActivityInsightsCosDetailsV2Options.Builder().build();
  }
