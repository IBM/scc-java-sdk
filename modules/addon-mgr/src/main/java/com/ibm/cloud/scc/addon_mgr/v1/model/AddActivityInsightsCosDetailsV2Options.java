...
/**
 * The addActivityInsightsCosDetailsV2 options.
 */
public class AddActivityInsightsCosDetailsV2Options extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(AddActivityInsightsCosDetailsV2Options addActivityInsightsCosDetailsV2Options) {
      this.regionId = addActivityInsightsCosDetailsV2Options.regionId;
      this.cosDetails = addActivityInsightsCosDetailsV2Options.cosDetails;
      this.transactionId = addActivityInsightsCosDetailsV2Options.transactionId;
    }
    ...
    /**
     * Builds a AddActivityInsightsCosDetailsV2Options.
     *
     * @return the new AddActivityInsightsCosDetailsV2Options instance
     */
    public AddActivityInsightsCosDetailsV2Options build() {
      return new AddActivityInsightsCosDetailsV2Options(this);
    }
     ...
     * @return the AddActivityInsightsCosDetailsV2Options builder
     */
  ...
  protected AddActivityInsightsCosDetailsV2Options(Builder builder) {
   ...
   * New builder.
   *
   * @return a AddActivityInsightsCosDetailsV2Options builder
   */
