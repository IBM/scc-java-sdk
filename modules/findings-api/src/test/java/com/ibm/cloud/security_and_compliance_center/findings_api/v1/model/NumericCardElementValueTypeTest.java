...
/**
 * Unit test class for the NumericCardElementValueType model.
 */
public class NumericCardElementValueTypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testNumericCardElementValueType() throws Throwable {
    ...
    String json = TestUtilities.serialize(numericCardElementValueTypeModel);

    NumericCardElementValueType numericCardElementValueTypeModelNew = TestUtilities.deserialize(json, NumericCardElementValueType.class);
    assertTrue(numericCardElementValueTypeModelNew instanceof NumericCardElementValueType);
    assertEquals(numericCardElementValueTypeModelNew.kind(), "KPI");
    assertEquals(numericCardElementValueTypeModelNew.kpiNoteName(), "testString");
    assertEquals(numericCardElementValueTypeModelNew.text(), "testString");
  }
}