...
public class ApiOccurrenceTest {
  ...
  public void testApiOccurrence() throws Throwable {
    ...
    assertEquals(apiOccurrenceModel.createTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(apiOccurrenceModel.updateTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    ...
    assertEquals(apiOccurrenceModelNew.createTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(apiOccurrenceModelNew.updateTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
