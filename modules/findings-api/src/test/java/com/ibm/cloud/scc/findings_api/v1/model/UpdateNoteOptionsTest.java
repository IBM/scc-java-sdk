...
public class UpdateNoteOptionsTest {
  ...
  public void testUpdateNoteOptions() throws Throwable {
    ...
    assertEquals(updateNoteOptionsModel.expirationTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(updateNoteOptionsModel.createTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(updateNoteOptionsModel.updateTime(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    ...
    assertEquals(updateNoteOptionsModel.transactionId(), "testString");
  }
