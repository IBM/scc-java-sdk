...
import com.ibm.cloud.scc.notifications.v1.Notifications;
...
/**
 * Unit test class for the Notifications service.
 */
@PrepareForTest({ EnvironmentUtils.class })
@PowerMockIgnore({"javax.net.ssl.*", "org.mockito.*"})
public class NotificationsTest extends PowerMockTestCase {
  ...
  public void constructClientService() throws Throwable {
    ...
    notificationsService = Notifications.newInstance(serviceName);
    String url = server.url("/").toString();
    notificationsService.setServiceUrl(url);
  }
  ...
  */
  ...
  public void testConstructorWithNullAuthenticator() throws Throwable {
    ...
    new Notifications(serviceName, null);
  }
  ...
  public void testListAllChannelsWOptions() throws Throwable {
    ...
    Response<ChannelsList> response = notificationsService.listAllChannels(listAllChannelsOptionsModel).execute();
  ...
  public void testListAllChannelsNoOptions() throws Throwable {
    ...
    notificationsService.listAllChannels(null).execute();
  }
  ...
  public void testCreateNotificationChannelWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<ChannelInfo> response = notificationsService.createNotificationChannel(createNotificationChannelOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testCreateNotificationChannelNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.createNotificationChannel(null).execute();
  }
  ...
  public void testDeleteNotificationChannelsWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<ChannelsDelete> response = notificationsService.deleteNotificationChannels(deleteNotificationChannelsOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testDeleteNotificationChannelsNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.deleteNotificationChannels(null).execute();
  }
  ...
  public void testDeleteNotificationChannelWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<ChannelDelete> response = notificationsService.deleteNotificationChannel(deleteNotificationChannelOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testDeleteNotificationChannelNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.deleteNotificationChannel(null).execute();
  }
  ...
  public void testGetNotificationChannelWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<ChannelGet> response = notificationsService.getNotificationChannel(getNotificationChannelOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testGetNotificationChannelNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.getNotificationChannel(null).execute();
  }
  ...
  public void testUpdateNotificationChannelWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<ChannelInfo> response = notificationsService.updateNotificationChannel(updateNotificationChannelOptionsModel).execute();
    assertNotNull(response);
    ChannelInfo responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testUpdateNotificationChannelNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.updateNotificationChannel(null).execute();
  }
  ...
  public void testTestNotificationChannelWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<TestChannel> response = notificationsService.testNotificationChannel(testNotificationChannelOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testTestNotificationChannelNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.testNotificationChannel(null).execute();
  }
  ...
  public void testGetPublicKeyWOptions() throws Throwable {
    ...
    // Invoke operation with valid options model (positive test)
    Response<PublicKeyGet> response = notificationsService.getPublicKey(getPublicKeyOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testGetPublicKeyNoOptions() throws Throwable {
    ...
    // Invoke operation with null options model (negative test)
    notificationsService.getPublicKey(null).execute();
  }
